//! `NodeIndex`, a narrowly-scoped native replacement for
//! `CFRSolver._index: dict[str, int]` in `cfr.py` (see that module's
//! docstring and `BENCHMARKS.md`'s "情報集合の保存方式" section for
