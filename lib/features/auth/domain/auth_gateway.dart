...
abstract class AuthGateway {
  ...
  /// アプリに戻ってきたときに、[changes] でサインインが分かる。
  ///
  /// 匿名セッション中は [registerEmail] と同じ「昇格」として扱い、
  /// user_id を維持したまま Google をログイン手段として追加する
  /// （この端末の学習履歴は失われない）。既にメール登録などで
  /// 匿名でなくなっている場合だけ、[signIn] と同様の別アカウントへの
  /// 切り替えになる。
  ///
